...
pub(in crate::pixel_painter) struct WeatherLight {
    pub intensity: f32,
    pub beam_strength: f32,
    pub night_sky: f32,
}

pub(in crate::pixel_painter) fn weather_light(w: Weather) -> WeatherLight {
...
pub(in crate::pixel_painter) struct TimeOfDayLook {
    ...
    pub(in crate::pixel_painter) twilight: f32,
}
...
pub(in crate::pixel_painter) fn time_of_day_look(now: SystemTime, theme: &Theme) -> TimeOfDayLook {
    ...
    let twilight = crate::pixel_painter::palette::bell(h, 6.5, 1.5)
        .max(crate::pixel_painter::palette::bell(h, 18.5, 1.5));
