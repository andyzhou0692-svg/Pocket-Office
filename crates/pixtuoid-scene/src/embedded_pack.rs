...
fn load_embedded_pack() -> Result<Pack> {
    ...
    load_pack_from_strings(
        ...
        embedded_sprites![
            ...
            "trading_command_wall.sprite",
            "trading_ticker.sprite",
            "trading_desk_rig.sprite",
            "trading_clutter.sprite",
            "trading_bonus_board.sprite",
            "trading_phone_bank.sprite",
            "trading_velcro_target.sprite",
            "executive_runner.sprite",
            "executive_art_wall.sprite",
            "executive_money_painting.sprite",
            "executive_marble_floor.sprite",
            "executive_board_table.sprite",
            "executive_bar.sprite",
            "executive_sculpture.sprite",
            "executive_chandelier.sprite",
        ],
    )
}
