...
pub static TOKYO_NIGHT: Theme = Theme {
    ...
    office: OfficeColors {
        ...
        city_lit_window: Rgb(224, 175, 104),
    ...
    lighting: LightingColors {
        day_sky_a: Rgb(65, 72, 104),
        day_sky_b: Rgb(90, 98, 130),
        night_sky_a: Rgb(18, 18, 30),
        night_sky_b: Rgb(26, 27, 42),
        twilight_a: Rgb(187, 154, 247),
        twilight_b: Rgb(247, 118, 142),
        sun_spill: Rgb(224, 175, 104),
        ceiling_pool: Rgb(192, 202, 230),
        floor_lamp_halo: Rgb(224, 175, 104),
        night_tint: Rgb(14, 14, 24),
    },
    furniture: FurnitureColors {
        wood_top: Rgb(52, 56, 78),
        wood_trim: Rgb(36, 38, 54),
        rug_field: Rgb(45, 35, 65),
        rug_trim: Rgb(30, 24, 45),
        rug_accent: Rgb(187, 154, 247),
